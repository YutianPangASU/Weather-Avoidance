...
class weather_cube_generator(object):
    def __init__(self, cfg):
        ...
        # clear up target data store directory
        try:
            os.makedirs('weather_data/{}_{}_ET'.format(self.date, self.sector_name))
        except OSError:
            pass
        try:
            os.makedirs('weather_data/{}_{}_ET_point'.format(self.date, self.sector_name))
        except OSError:
            pass
