...
To run the script, change "path_to_data" and paste "./flight_data_parser.py" in terminal.
...
if __name__ == '__main__':
    ...
    cfg = {'departure_airport': 'LAX',
           'arrival_airport': 'PHX',
           'chunk_size': 1e6,
           'file_date': 20170406,
           'path_to_data': '/media/ypang6/Yutian Pang 4TB/Research/data'}
